...
/*   Updated: 2023/03/10 17:41:31 by abuonomo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_w(t_game *game)
{
	if (game->map[game->pi - 1][game->pj] != '1')
	{
		...
		if (game->map[game->pi - 1][game->pj] == 'Z')
			exit_died(game);
		if (game->map[game->pi - 1][game->pj] == '0'
			|| game->map[game->pi - 1][game->pj] == 'C')
		{
			game->pi--;
...
void	move_a(t_game *game)
{
	if (game->map[game->pi][game->pj - 1] != '1')
	{
		...
		if (game->map[game->pi][game->pj - 1] == 'Z')
			exit_died(game);
		if (game->map[game->pi][game->pj - 1] == '0'
			|| game->map[game->pi][game->pj - 1] == 'C')
		{
			game->pj--;
			game->map[game->pi][game->pj] = 'P';
